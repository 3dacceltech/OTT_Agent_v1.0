        ...
        if (this.videoEl && !this.videoEl.paused && !this.videoEl.ended) {
            try {
                ...
                detections.forEach((detection, index) => {
                    ...
                    console.log(` Box: (x: ${boundingBox.originX}, y: ${boundingBox.originY}, w: ${boundingBox.width}, h: ${boundingBox.height})`);
                    console.log(` Class: ${category.categoryName}, Score: ${category.score.toFixed(2)}`);
                });
            } catch (error) {
